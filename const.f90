module const
  ...
  integer, parameter :: nz    = 128       ! number of grid points in y
  ...
  integer, parameter :: np    = 50*nx     ! number of particles in each (y,z)
  integer, parameter :: nsp   = 2         ! number of particle species

  !number of processes
  integer, parameter :: nproc = 256
  integer, parameter :: nproc_i = 1 ! number of processes in x
  integer, parameter :: nproc_j = 8 ! number of processes in y
