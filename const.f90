module const
  ...
  implicit none
  integer, parameter :: nx    = 6001     ! number of grid points in x
  integer, parameter :: ny    = 8       ! number of grid points in y
  integer, parameter :: nz    = 6       ! number of grid points in y
  ...
  integer, parameter :: np    = 200*nx     ! number of particles in each (y,z)
  integer, parameter :: nsp   = 2         ! number of particle species

  !number of processes
  integer, parameter :: nproc   = 1
  integer, parameter :: nproc_i = 1 ! number of processes in x
  integer, parameter :: nproc_j = 1 ! number of processes in y
