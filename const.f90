...
!!************************ NUMERICAL CONSTANTS ************************!!
  ...
  integer, parameter :: nproc   = 9216      ! NUMBER OF PROCESSES
...
!! SETUP FOR MOVING INJECTOR; INITIAL DOMAIN SIZE IN X
  ...
  integer            :: nxe     = nxgs+nx*0.2 ! INITIAL SIZE
...
!! SETUP FOR MAIN PROGRAM & SUBROUTINES
  ...
  integer, parameter :: intvl1  = 25000    !INTERVAL FOR PARTICLES & FIELDS STORAGE          
  integer, parameter :: intvl2  = 2         !INTERVAL FOR INJECTING PARTICLES
  integer, parameter :: intvl3  = 20        !INTERVAL FOR EXPANDING PHYSICAL REGION IN X
  integer, parameter :: intvl4  = 175000    !INTERVAL FOR RECONDING MOMENT DATA
  character(len=128) :: dir     = './'      !DIRECTORY FOR OUTPUT
  character(len=128) :: file9   = 'init_param.dat' !FILENAME OF INIT CONDITIONS
  real(8), parameter :: etlim   = 23.0*60.*60. !MAX. ELAPSE TIME IN SEC.
