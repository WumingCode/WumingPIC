...
!!************************ NUMERICAL CONSTANTS ************************!!
  integer, parameter :: nx      = 5001      ! NUMBER OF GRID POINTS IN X
  integer, parameter :: ny      = 288      ! NUMBER OF GRID POINTS IN Y
  integer, parameter :: nz      = 288       ! NUMBER OF GRID POINTS IN Y
  ...
  integer, parameter :: nproc_j = 48        ! NUMBER OF PROCESSES IN Y
...
!! SETUP FOR MOVING INJECTOR; INITIAL DOMAIN SIZE IN X
  ...
  integer            :: nxe     = nxgs+2000 ! INITIAL SIZE

!! SETUP FOR MAIN PROGRAM & SUBROUTINES
  integer, parameter :: itmax   = 4000    !NUMBER OF ITERATION
  integer            :: it0     = 0	!0:INITIAL, NONZERO/9999999: RESTART DATA
  integer, parameter :: intvl1  = 4001    !INTERVAL FOR PARTICLES & FIELDS STORAGE          
  ...
  character(len=128) :: dir     = './test/'      !DIRECTORY FOR OUTPUT
  character(len=128) :: file9   = 'init_param.dat' !FILENAME OF INIT CONDITIONS
  real(8), parameter :: etlim   = 2.*60.*60. !MAX. ELAPSE TIME IN SEC.
